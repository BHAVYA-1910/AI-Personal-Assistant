              ...
              <DialogHeader>
                  ...
                  <DialogDescription asChild>
                      <div className='grid grid-cols-3 gap-5'>
                        <div className='mt-3 border-r p-2'>
                            <Button variant={'secondary'} size={'sm'} 
                            onClick={()=>setSelectedAssistant(DEFAULT_ASSISTANT)}
                            className='w-full cursor-pointer'>+ Create New Assistant</Button>
                            <div className='mt-3'>
                                {AiAssistantsList.map((assistant,index)=>(
                                  <div className='p-1.5 hover:bg-secondary flex gap-2 items-center rounded-xl cursor-pointer'
                                  onClick={()=>setSelectedAssistant(assistant)}
                                  >
                                      <Image src={assistant.image} width={60} height={60} alt={assistant.name}
                                          className='w-[43px] h-[43px] object-cover rounded-lg'
                                      />
