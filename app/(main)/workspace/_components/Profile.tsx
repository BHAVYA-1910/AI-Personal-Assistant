                          ...
                          <div>
                                ...
                                <div className='flex flex-col gap-2'>
                                    ...
                                    <h2 className='flex justify-between font-bold mt-3 text-lg'>Current Plan 
                                        <span className='p-1 bg-gray-100 dark:bg-slate-700 rounded-md px-2 font-normal'>{!user?.orderId?'Free Plan':'Pro Plan'}</span></h2>
                                </div>


                                {!user?.orderId? <div className='p-4 border rounded-xl mt-3'>
