...
function AIAssistants() {
  ...
  return (
    <div className='px-10 mt-3 md:px-28 lg:px-36 xlpx-48'>
        <div className='flex justify-between items-center'>  
            ...
            <Button disabled={selectedAssistants?.length==0||loading}
        ...
        <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-5 mt-5'>
            {AiAssistantsList.map((assistant,index) => (
                ...
                <div key={index} className='hover:border p-3 rounded-xl hover:scale-105 transition-all ease-in-out 
                cursor-pointer relative' onClick={()=>onSelect(assistant)}>
